...
```{r}
#| label: fig-netyref
#| fig-cap: "Coupling network of shared references represented per publishing year (in x-axis) and per module (in y-axis and in different colors). Nodes are articles and edges represent the shared cited references."
#| 
...
```{r}
#| label: fig-baryref
#| fig-cap: "Number of references per year and per module."
#| 
